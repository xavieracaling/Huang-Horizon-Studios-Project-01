...
public class Rusher : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        button.onClick.AddListener(() => 
        {
            ...
            {
               GameManager.Instance.CurrentUsedPlayerBoosterPackProtected.TimeExpirationsProtected.DailyResetTarget = (DateTimeOffset.UtcNow + TimeSpan.FromHours(24) ).ToUnixTimeMilliseconds();
            }
